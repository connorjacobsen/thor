...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Article.home_site'
        db.alter_column(u'succinctly_article', 'home_site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['succinctly.Website'], null=True))

    def backwards(self, orm):

        # Changing field 'Article.home_site'
        db.alter_column(u'succinctly_article', 'home_site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['succinctly.Website'], null=True, on_delete=models.SET_NULL))
